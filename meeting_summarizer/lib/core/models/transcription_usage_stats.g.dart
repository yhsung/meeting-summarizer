...
TranscriptionUsageStats _$TranscriptionUsageStatsFromJson(
    ...
    TranscriptionUsageStats(
      ...
      providerStats: (json['providerStats'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
                k, ProviderUsageStats.fromJson(e as Map<String, dynamic>)),
          ) ??
          const {},
      dailyStats: (json['dailyStats'] as Map<String, dynamic>?)?.map(
            (k, e) => MapEntry(
                k, DailyUsageStats.fromJson(e as Map<String, dynamic>)),
          ) ??
          const {},
...
ProviderUsageStats _$ProviderUsageStatsFromJson(Map<String, dynamic> json) =>
    ProviderUsageStats(
      ...
      failedRequests: (json['failedRequests'] as num).toInt(),
      totalProcessingTime:
          Duration(microseconds: (json['totalProcessingTime'] as num).toInt()),
      totalAudioMinutes: (json['totalAudioMinutes'] as num).toInt(),
...
Map<String, dynamic> _$PeakUsageMetricsToJson(PeakUsageMetrics instance) =>
    <String, dynamic>{
      ...
      'peakHourlyRequestsTime':
          instance.peakHourlyRequestsTime.toIso8601String(),
    };
